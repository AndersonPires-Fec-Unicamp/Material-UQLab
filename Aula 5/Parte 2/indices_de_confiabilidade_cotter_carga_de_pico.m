...
minha_analise_sensibilidade_cotter = uq_createAnalysis(analise_sensibilidade_cotter);

uq_print(minha_analise_sensibilidade_cotter)
uq_display(minha_analise_sensibilidade_cotter)
